    ...
    <>
      <Layout>
        <div className="flex flex-col items-center justify-center bg-[#f3f5ff] min-h-screen py-12 text-center gap-y-6">
          ...
          <h2 className="flex space-y-4 text-4xl font-semibold text-black">
            Why Choose Us?
          </h2>
          ...
          <h1 className="text-3xl font-semibold lg:mt-4 text-nowrap">
            <span className="bg-gradient-to-r from-purple-500 to-cyan-400 bg-clip-text text-transparent mb-6">
              Meet Our Tech Team
            </span>
            <span> 💡</span>
          </h1>
          ...
          <div className="flex flex-col min-h-screen min-w-full items-center justify-center text-center bg-[linear-gradient(to_bottom,_#f3f5ff_1%,_transparent_40%),radial-gradient(circle_at_center,_#a2f8d3,_#c7ade2,_#a4d8fd)] -mb-14">

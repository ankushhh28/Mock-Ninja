...
const ImageSlider = () => {
  ...
  return (
    <Box className="flex flex-col gap-10 md:gap-28  items-center min-h-screen w-full bg-[#f5f3ff] px-12 md:px-20  pt-10 md:pt-20 ">
      <Box className="relative flex items-center justify-between w-80 h-16 rounded-full bg-gray-200 shadow-xl p-2 mt-6">
        <Box
      ...
      <Box className="flex flex-col md:flex-row items-center justify-between w-full mt-10">
        <Box className="flex flex-col items-start text-left w-full md:w-1/2 space-y-8">
          <Typography className="text-5xl md:text-6xl font-extrabold tracking-tighter text-black">
          ...
          <Box className="flex flex-col md:flex-row gap-4">
            <Button
              className="normal-case text-white bg-gradient-to-r from-gray-800 via-gray-700 to-gray-950 hover:from-[#764de8] hover:to-purple-600 px-6 py-4 font-bold text-xl rounded-xl flex items-center transition-all duration-300 shadow-md hover:shadow-lg"

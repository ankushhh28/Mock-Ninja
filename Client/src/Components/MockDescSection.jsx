...
const MockDescSection = () => {
  return (
    <section className="flex flex-col content-between items-center md:px-12 lg:px-20 py-16 max-w-7xl mx-auto space-y-12">

      {/* textLeft----------------------------------------------------------------------------------------------------------------- */}
      
      <div className="flex flex-col lg:flex-row items-center justify-between w-full lg:px-20 px-4">
        <div className="lg:w-1/2 text-center lg:text-left">
          ...
          Get personalized interview questions based on your resume, domain, and skills. AI analyzes your responses, eye contact, and body language to provide detailed feedback. Get an ATS resume score with improvement tips to pass automated screenings.
          </p>
          <a
            href="#"
            className="mt-6 text-lg font-semibold text-black italic flex space-x-2"
          >
        ...
        <div className="mt-10 lg:mt-0 lg:w-1/2 flex justify-center">
          <div className="bg-[#c28ceb] p-6 rounded-3xl shadow-lg w-full max-w-sm">
            <div className="bg-white p-4 rounded-xl flex items-center space-x-3">
              ...
              />
              <div>
                <h3 className="text-lg font-semibold text-gray-900">AI Interview Bot</h3>
                <p className="text-sm text-gray-500">Your virtual interviewer</p>
              </div>
            </div>
            <div className="w-7xl p-4 flex ml-24">
              <img
                src={longbot}
                alt="AI Bot"
                className="w-28 h-36"
      ...
      <div className="flex flex-col lg:flex-row-reverse items-center justify-between w-full lg:px-20 px-4">
        <div className="lg:w-1/2 text-center lg:text-left">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
          ...
          <a
            href="#"
            className="mt-6 text-lg font-semibold text-black flex items-center space-x-2"
          >

...
export default function Ats() {
  ...
  return (
    <Box className="bg-[#f5f3ff] h-fit py-10">
      <div
        className="flex flex-col lg:flex-row bg-gradient-to-b from-[#c28ceb] to-[#8667F2] text-white 
        ...
        <section className="flex flex-col lg:flex-row w-full">
          <div className="flex flex-col justify-center text-center lg:ml-16 p-8 w-full">
            ...
            <p className="mt-4 text-lg text-gray-200">
              Our <span className="font-bold">free</span> AI-powered resume
              checker scores your resume on key criteria recruiters and hiring
              managers look for. Get actionable steps to revamp your resume and{" "}
              <span className="font-bold">land more interviews.</span>
            </p>

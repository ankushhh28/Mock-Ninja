...
const InterviewerBanner = () => {
  ...
  <div className="relative right-8 sm:right-14 md:right-16 lg:right-8 xl:right-20 flex flex-col items-center md:items-end">
    ...
    ></video>
      ...
      >
        <div className="bg-gradient-to-br from-[#9870e9] to-[#8E2DE2] shadow-2xl max-w-lg w-full p-8 text-center text-white">
          ...
          <DialogContent className="mt-4 px-6 text-lg sm:text-xl leading-relaxed">
            To become an interviewer or schedule a mock interview, sign in or
            create an account.
          </DialogContent>
      ...
      {/* --------------------- Interviewer Dashboard Image & Content ---------------------- */}
      <Box className="flex flex-col md:flex-row items-center justify-between w-full mt-10">
        <Box className="flex flex-col items-start text-left w-full md:w-1/2 space-y-8">
          ...
          <Typography className="text-gray-700 font-semibold text-xl md:text-2xl">
            Join a community of industry professionals who help job seekers gain
            real-world interview experience. Conduct mock interviews, assess
            their strengths and weaknesses, and provide actionable feedback to
            refine their skills. Earn rewards while making a lasting impact on

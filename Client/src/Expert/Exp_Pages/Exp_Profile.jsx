...
const Exp_Profile = () => {
  ...
  return (
    <ExpertLayout>
      <Box className="min-h-screen w-full bg-gray-50 py-8">
        {/* ------------------------TOP NAVBAR-------------------------- */}

        <Box className="mx-6 md:mx-16 sticky z-10 top-0 bg-gray-50 border-b-2">
          <Box className="flex justify-between items-center px-4 sm:px-8 pb-6 border-b border-gray-200">
            ...
            <Box className="flex gap-4">
              {isEditing && !loading ? (
                <Button
                  ...
                  variant="contained"
                  startIcon={<EditIcon />}
                  className="bg-blue-600 hover:bg-blue-700 text-white w-16 md:w-24 font-light md:font-medium rounded-lg transition-all duration-300 text-wrap"
                  sx={{
        ...
        <Box className="flex flex-col md:flex-row gap-8 w-full max-w-7xl mx-auto mt-8 px-4 sm:px-8">
          ...
          <Box className="flex flex-col  w-full md:w-[120%] px-12 py-6 rounded-3xl mx-auto">
            {/* -----------------------------PROFILE IMAGE-------------------------------- */}

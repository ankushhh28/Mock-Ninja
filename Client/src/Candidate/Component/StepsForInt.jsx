...
const StepsForInt = () => {
  ...
  return (
    <>
      <h1 className="px-10 pt-12 md:pt-16 lg:pt-20 md:px-14 md:pb-10 lg:pb-12 text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-700 w-full bg-[#f3f5ff] ">
        Follow these Steps to
        <span className="text-primary"> Ace Your Interview!</span>
      </h1>
      <div className="flex flex-col-reverse md:flex-row w-full  px-12  gap-12 md:gap-8 items-center justify-center pb-20 bg-[#f5f3ff]">
        <div className="space-y-4 w-full md:w-[60%] lg:w-[75%] ">
          <div
            className={`relative rounded-lg px-4 py-4 sm:px-4  sm:py-6 text-xl transition-all duration-300 ${
              activeStep === 0
                ? "bg-[#8667F2] text-white"
                : "bg-[#e0c3fc] text-gray-700"
            }`}
          >
            <button className="flex items-center w-full text-left font-medium text-xl md:text-2xl">
              <span><OneIcon className="text-3xl mr-3"/></span>Upload Resume or Select Domain or Choose any Skill
            </button>
            {activeStep === 0 && (
              <div

...
const Can_Card = () => {
  return (
    <Box className="flex flex-col sm:flex-row items-center gap-12 bg:[#f5f3ff] px-6 py-3">
      ...
      <Box className="w-full lg:w-1/2 text-center lg:text-left md:mr-6">
        <Typography variant="h4" className="text-primary font-extrabold mb-4 whitespace-nowrap text-wrap overflow-visible">
